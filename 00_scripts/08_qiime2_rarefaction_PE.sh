...
# Note: max-depth should be chosen based on ConTable.qzv (or on /scratch_vol0/fungi/eDNA_new_caledonian_lagoon_diversity/05_QIIME2/export/visual/ConTable/sample-frequency-detail.csv)
